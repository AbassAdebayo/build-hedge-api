...
{
    /// <inheritdoc />
    public partial class AddNoticeFlagsToHedgeEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<DateTime>(
                name: "IsFinalNoticeSent",
                table: "HedgeContracts",
                type: "datetime2",
                nullable: true);

            migrationBuilder.AddColumn<DateTime>(
                name: "IsSevenDayNoticeSent",
                table: "HedgeContracts",
                type: "datetime2",
                nullable: true);
            ...
            migrationBuilder.UpdateData(
                ...
                column: "CreatedAtUtc",
                value: new DateTime(2026, 2, 24, 15, 38, 34, 849, DateTimeKind.Utc).AddTicks(7486));
        }
