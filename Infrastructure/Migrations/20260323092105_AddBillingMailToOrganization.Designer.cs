...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260323092105_AddBillingMailToOrganization")]
    partial class AddBillingMailToOrganization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.BillingStatement", b =>
                {
                    ...
                    b.Property<decimal>("SubscriptionBaseFee")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal>("TotalOverageFees")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal>("TotalPremiumFees")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("Domain.Entities.HedgeContract", b =>
                {
                    ...
                    b.Property<DateTime?>("IsExpiredNoticeSentAt")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("IsFinalNoticeSent")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("IsSevenDayNoticeSent")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Domain.Entities.ProcessedPayment", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.UserOrganizationMembership", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAtUtc = new DateTime(2026, 3, 23, 9, 21, 3, 750, DateTimeKind.Utc).AddTicks(6945),
                            CreatedBy = "Hedge_System",
            ...
            modelBuilder.Entity("Domain.Entities.HedgeContract", b =>
                {
                    b.HasOne("Domain.Entities.BillingStatement", null)
                        .WithMany("HedgesIncluded")
