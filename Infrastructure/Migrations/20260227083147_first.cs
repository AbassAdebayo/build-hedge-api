        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionBaseFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalPremiumFees = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalOverageFees = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsExpiredNoticeSentAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsSevenDayNoticeSent = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsFinalNoticeSent = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    TotalValueBaseCurrency = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    OverageFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BillingStatementId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastUpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HedgeContracts_BillingStatements_BillingStatementId",
            ...
            migrationBuilder.InsertData(
                table: "Organizations",
                columns: new[] { "Id", "AccruedFees", "BaseCurrencyCode", "BusinessName", "CreatedAtUtc", "CreatedBy", "IsActive", "IsDeleted", "IsInTrial", "LastUpdatedBy", "SubscriptionExpiryDate", "SubscriptionPlan", "TaxId", "TrialExpiryDate", "UpdatedAtUtc" },
                values: new object[] { new Guid("c8f2e6ab-9f34-4b97-8b7c-1a5e86d78e42"), 0m, "NGN", "Build Hedge", new DateTime(2026, 2, 20, 0, 0, 0, 0, DateTimeKind.Utc), "Hedge_System", true, false, true, null, null, 1, null, null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("c8f2e6ab-9f34-4b97-8b7c-1a5e86d78e42"), new Guid("c8f2e5ab-9f34-4b97-8b7c-1a5e86c77e42"), new DateTime(2026, 2, 27, 8, 31, 45, 395, DateTimeKind.Utc).AddTicks(547), "Hedge_System", new Guid("7ad9b1e1-4c23-46a2-b8e4-219ab417f71f"), false, new DateTime(2026, 2, 20, 0, 0, 0, 0, DateTimeKind.Utc), null, "Hedge_Owner", null });

            migrationBuilder.CreateIndex(
                name: "IX_HedgeContracts_BillingStatementId",
